...
import Male from "../assets/maleAttendant.jpeg";
...
const navigate = useNavigate()
  ...
  const features = [
    { id: 1, text: "Turn on your location to locate the quick filler stations around you." },
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg w-full mx-auto mt-10">
          ...
          <div className="flex flex-row justify-between">
            ...
            <div className="mt-4 p-2 ">
              ...
              <button onClick={handleClick} className="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded block   mt-4">
                Petrol Filling
              </button>
